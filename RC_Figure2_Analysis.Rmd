...
extract_cols_for_plot <- function(df){
 df <- tibble(Position = rep(1:bin, times=nrow(df)), 
             ...
             cue_group_o = rep(df$cue_group_o, each=bin), 
             reset_group = rep(as.character(df$reset_group), each=bin), 
             reset_group_p = rep(as.character(df$reset_group_p), each=bin)) 
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negneg_reset_probe_JustP.png",width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negneg_reset_probe_BandP.png", width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negneg_all_probe_BandP.png",  width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negneg_reset_probe_JustB.png",  width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/NegPos_reset_probe_JustP.png", width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negpos_reset_probe_BandP.png",  width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Negpos_reset_probe_JustB.png",  width = 3.6, height = 2.9)
}
```
...
if (save_figures == 1) {
  ggsave(file = "plots/Pospos_reset_probe_JustP.png", width = 3.6, height = 2.9) 
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Pospos_reset_probe_BandP.png",  width = 3.6, height = 2.9) 
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Pospos_all_probe_BandP.png",  width = 3.6, height = 2.9) 
}
```
...
if (save_figures == 1) {
  ggsave(file = "plots/Posneg_reset_probe_JustP.png", width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Posneg_reset_probe_BandP.png",  width = 3.6, height = 2.9)
}
```
...
if (save_figures == 1) {
  ggsave(file = "plots/posnon_reset_probe_JustB.png",  width = 3.6, height = 2.9)
}
```
...
if (save_figures == 1) {
  ggsave(file = "plots/negnon_reset_probe_JustP.png",  width = 3.6, height = 2.9)
}
```
```{r}
# -/- on beaconed but not probe trials
...
if (save_figures == 1) {
  ggsave(file = "plots/Negneg_reset_probe_negUNonProbe.png",  width = 3.6, height = 2.9)
}
...
```{r}
pi_data <- subset(spatial_firing_probeonly, final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA")
```
...
```{r}
spatial_firing_save <- select(spatial_firing,c('session_id', 'cluster_id', 'Mouse', 'Day', 'Day_numeric',  'cohort', 'number_of_rewards', 'max_trial_number','spikes_in_time', 'Rates_averaged_rewarded_b', 'Rates_averaged_rewarded_nb', 'Rates_averaged_rewarded_p','spikes_in_time', 'lm_group_b', 'lm_group_nb', 'lm_group_p', 'final_model_o_b', 'lm_group_b_h', 'lm_group_nb_h', 'lm_group_p_h'))
```
