...
Edit: We're only making 2 shuffles and will fill the shuffled rate tables with shuffled data generated in Python at the spike-level. 
Set this to 1000 and disregard the next step if you want to use the space binned fr method of shuffling
```{r}
shuffles <- 2
...
2. Extract shuffled results from spike-level shuffle dataframe
```{r}
...
# set shuffles to 1000 as in the .feather file
shuffles <- 1000
```
