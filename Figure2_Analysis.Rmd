...
if(!"Rates_averaged_rewarded_b" %in% colnames(spatial_firing)) {
  spatial_firing <- spatial_firing %>%
...
ggplot(data=spatial_firing, aes(x= asr_b_rewarded_r2_o, fill=factor(unlist(lm_group), level = level_order))) + #fill=factor(unlist(slope_criteria_pval))
