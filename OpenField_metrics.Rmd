...
```{r}
spatial_firing <- subset(spatial_firing, joined_id != "M6_1" )
```
...
```{r}
spatial_cells <- nrow(subset(slope_df, classifier != "NS"))
...
## of ramp cells, what are proportions of grid, border etc


```{r}
all_cells_percent <- spatial_firing  %>%
  select(Mouse, cohort, classifier2) %>%
  group_by(Mouse, cohort, classifier2) %>%
  dplyr::summarise(n = n()) %>%
...
```{r}
ggplot(all_cells_percent, aes(x=classifier2, y=percent)) + 
  coord_cartesian(ylim=c(0,100)) +
  geom_boxplot(aes(fill = classifier2), alpha=0.9, outlier.colour="black", outlier.shape=16,
...
ggsave(file = "plots/OFAnalysis_proportionsBOX_allcells.png", width = 5, height = 4)
...
```{r}
ggplot(ramp_cells_percent, aes(x=classifier2, y=percent)) + 
  coord_cartesian(ylim=c(0,100)) +
  #geom_violin(aes(fill = classifier), trim=FALSE, alpha=0.3) +
  ...
  theme(axis.text.x = element_text(size=19),
        ...
        legend.text=element_text(size=19), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) 
ggsave(file = "plots/OFAnalysis_proportionsBOX_Positionrampcells.png", width = 5, height = 4)
...
```{r}
ggplot(speed_ramp_cells_percent, aes(x=classifier2, y=percent)) + 
  coord_cartesian(ylim=c(0,100)) +
  #geom_violin(aes(fill = classifier), trim=FALSE, alpha=0.3) +
  #stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="red") +
  geom_boxplot(aes(fill = classifier2), alpha=0.9, outlier.colour="black", outlier.shape=16,
  ...
  theme(axis.text.x = element_text(size=19),
        ...
        legend.text=element_text(size=19), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) 
ggsave(file = "plots/OFAnalysis_proportionsBOX_speedrampcells.png", width = 5, height = 4)
...
group_identifier <- rep(c("Ramps(P,PS,PA,PSA)"), times =nrow(ramp_cells_percent))
all_ramp_cells_percent <- cbind(ramp_cells_percent, group_identifier)

group_identifier <- rep(c("Ramps(S,A,SA)"), times =nrow(speed_ramp_cells_percent))
...
ggplot(df_all, aes(x=classifier2, y=percent)) + 
  coord_cartesian(ylim=c(0,100)) +
  #stat_summary(fun.data=mean_sdl, mult=1, geom="pointrange", color="red") +
  geom_boxplot(aes(fill = ...11), alpha=0.9, outlier.colour="black", outlier.shape=16,
             outlier.size=2, notch=FALSE) +
  scale_fill_manual(values=c("brown2", "darkturquoise", "darkorange","blueviolet", "blue3")) +
  theme_classic() +
  labs(y = "Percent", x ="") +
  ...
  theme(axis.text.x = element_text(size=19),
        ...
        legend.text=element_text(size=19), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) 
ggsave(file = "plots/OFAnalysis_proportionsBOX.png", width = 8, height = 4.5)
...
proportions_mixed_ramps <- tibble(
  ...
  ramp_type = c("Grid", "Grid", "Grid", "Grid", "Grid", "Grid", "Border", "Border", "Border", "Border", "Border", "Border", "Speed", "Speed", "Speed", "Speed", "Speed", "Speed", "HD", "HD", "HD", "HD", "HD", "HD", "Spatial", "Spatial", "Spatial", "Spatial", "Spatial", "Spatial", "Non-spatial", "Non-spatial", "Non-spatial", "Non-spatial", "Non-spatial", "Non-spatial"))
```
...
ggplot(proportions_mixed_ramps, aes(x= ramp_id, y = perc, fill=factor(ramp_type))) +
  ...
  labs(y = "Percent", x="") +
  scale_fill_manual(values=c("brown2", "darkturquoise", "darkorange","blueviolet", "blue3", "brown2")) +
...
ggplot() + 
    ...
    theme_classic() +
    scale_color_manual(values=c("brown2", "darkturquoise", "darkorange","blueviolet", "blue3")) +
...
if (save_figures == 1) {
 ggsave(file = "plots/Spatialscore_vs_cutoff_groups.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/speedvr_vs_speedof_groups_speedcellsvr.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/speedvr_vs_speedof_groups_speedcellsof.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/speedvr_vs_slope_groups_position.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/HDscore_vs_slope_allcells_position.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/borderscore_vs_slope_allcells_position.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/gridscore_vs_slope_allcells_position.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_allpositioncells.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_allcells_facet_groupbyclassifier.png", width = 8, height = 6) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_allcells_test.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_positioncells_test.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_allrampcells.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_allrampcells_facet.png", width = 8, height = 6) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_CV2_allrampcells.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_cv2_allrampcells_facet.png", width = 5, height = 4.5) 
}
```
...
ggplot() + 
    ...
    xlab("Mean firing rate (Hz)") +
    theme_classic() +
    scale_color_manual(values=c("brown2", "darkturquoise", "grey4")) +
    theme(axis.text.x = element_text(size=18),
          axis.text.y = element_text(size=18),
          legend.position="bottom", 
          legend.title = element_blank(),
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_CV2_allrampcells_groupedbycelltype.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/firing_properties_CV2_allrampcells_groupedbyclassifier.png", width = 5, height = 4.5) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FR_dist_nonrampcells.png", width = 3.5, height = 3) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FRvr_dist_nonrampcells_facet.png",  width = 8, height = 6) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FRvr_dist_allrampcells_facet.png",  width = 8, height = 6) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FRvr_dist_nonrampcells.png", width = 3.5, height = 3) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FR_dist_allrampcells.png",width = 3.5, height = 3) 
}
```
...
ggplot(data=subset(position_data,track_category != "None"), aes(x = unlist(mean_firing_rate_of), fill=as.factor(unlist(classifier2)))) +
  ...
  theme(axis.text.x = element_text(size=16),
        ...
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0)))
if (save_figures == 1) {
 ggsave(file = "plots/FR_dist_allrampcells_facet.png",width = 8, height = 6) 
}
```
...
if (save_figures == 1) {
 ggsave(file = "plots/FRvr_dist_allrampcells.png", width = 3.5, height = 3) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/FRdiff_dist_nonrampcells.png",width = 3.5, height = 3) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/FRdiff_dist_allrampcells.png", width = 3.5, height = 3) 
}
...
ggplot(data=subset(position_data,track_category != "None"), aes(x = (unlist(mean_firing_rate)-unlist(mean_firing_rate_of)), fill=as.factor(unlist(classifier2)))) +
  geom_histogram(aes(y=..count..)) +
  coord_cartesian(xlim = c(-50,50)) +
  scale_fill_manual(values=c("brown2", "darkturquoise", "darkorange","blueviolet", "blue3", "brown2")) +
  scale_y_continuous(breaks = scales::pretty_breaks(n = 3)) +
...
if (save_figures == 1) {
 ggsave(file = "plots/FRdiff_dist_allrampcells_facet.png",  width = 8, height = 6) 
}
