...
```{r}
ramps <- subset(spatial_firing_enoughtrials, lm_group_b == "Positive" | lm_group_b == "Negative")
```
...
if (save_figures==1) {
  ggsave(file = "plots/negative_relationship_AllSpeed.png", width = 4.5, height = 2.5)
}
```
...
if (save_figures==1) {
  ggsave(file = "plots/positive_relationship_AllSpeed.png", width = 4.5, height = 2.5)
}
```
