...
2. Plot offset for rewarded trials and run through trials
```{r}
plot_offset_comparison (allposition_ramps$predict_diff, allposition_ramps$predict_diff_run, allposition_ramps$reward_interaction_id)
...
3. Plot offset for rewarded trials and trials where the animal tries to stop
```{r}
plot_offset_comparison (allposition_ramps$predict_diff, allposition_ramps$predict_diff_try, allposition_ramps$reward_interaction_id)
