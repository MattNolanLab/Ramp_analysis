...
mean_SEM_plots_by_Outcome <- function(df, x_start = 00, x_end = 200) {
 ...
 ggplot(data=df) +
  annotate("rect", xmin=0, xmax=30, ymin=7,ymax=Inf, alpha=0.2, fill="Grey60") +
  annotate("rect", xmin=170, xmax=200, ymin=7,ymax=Inf, alpha=0.2, fill="Grey60") +
  annotate("rect", xmin=90, xmax=110, ymin=7,ymax=Inf, alpha=0.2, fill="Chartreuse4") +
