...
1. subset by outbound ramps (Figure 2) and for cells that are modulated by position in any way (P,PA,PS,PSA) as determined by Figure 3 (Figure3_Analysis.Rmd)
```{r}
...
3. Subset data by group then average rates for plotting **Negative coefficient with acceleration**
```{r}
(pos_plot <- mean_SD_plots_outbound(all_accel_neurons,  0, 200))
