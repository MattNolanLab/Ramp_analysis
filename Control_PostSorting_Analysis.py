...
def make_shuffled_plots(recording_folder,spike_data):
    Python_PostSorting.MakePlots_Shuffled.plot_shuffled_spikes_on_track(recording_folder,spike_data, prm, prefix='_movement')
    Python_PostSorting.MakePlots_Shuffled.plot_shuffled_firing_rate_maps(recording_folder,spike_data, prefix='_movement')
    return


def make_longer_track_plots(recording_folder, spike_data):
    Python_PostSorting.MakePlots.plot_spikes_on_track_tracks(recording_folder,spike_data, prm, prefix='_movement')
    Python_PostSorting.MakePlots.plot_smoothed_firing_rate_maps_tracks(recording_folder, spike_data, prefix='_movement')
    Python_PostSorting.GaussianConvolution_inSpace.make_convolved_firing_field_maps_for_tracks(recording_folder, spike_data)
    return
...
def run_trial_type_analysis(spike_data, server_path):
    spike_data = Python_PostSorting.TrialType_Comparison.generate_firingrate_diff_between_trialtypes(spike_data, server_path)
    spike_data = Python_PostSorting.TrialType_Comparison.generate_firingrate_comparison_between_trialtypes(spike_data)
    spike_data = Python_PostSorting.CrossCorrelateFR_TrialTypes.generate_crosscorr_of_trialtypes(spike_data, server_path)
