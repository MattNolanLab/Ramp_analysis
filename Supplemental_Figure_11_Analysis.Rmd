...
if (save_figures==1) {
 ggsave(file = "plots/TrialOutcome_NegNeg_allposition.png", width = 3.6, height = 2.9) 
}
...
if (save_figures==1) {
  ggsave(file = "plots/TrialOutcome_PosPos_allposition.png", width = 3.6, height = 2.9)
}
...
if (save_figures==1) {
  ggsave(file = "plots/TrialOutcome_PosNeg_allposition.png", width = 3.6, height = 2.9)
}
...
if (save_figures==1) {
  ggsave(file = "plots/TrialOutcome_NegPos_allposition.png", width = 3.6, height = 2.9)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Violin_Predict_Positive_JustPosition.png",width = 4, height = 2.5)
}
...
if (save_figures == 1) {
  ggsave(file = "plots/Violin_Predict_Negative_JustPosition.png",width = 4, height = 2.5)
}
