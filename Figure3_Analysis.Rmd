...
spatial_firing <- spatial_firing  %>%
  mutate(o_pos_b = map2(spikes_in_time, 0, car_pos),
         o_speed_b = map2(spikes_in_time, 0, car_speed),
         o_accel_b = map2(spikes_in_time, 0, car_accel),
         o_pos_nb = map2(spikes_in_time, 1, car_pos),
         o_speed_nb = map2(spikes_in_time, 1, car_speed),
         o_accel_nb = map2(spikes_in_time, 1, car_accel))
  # o_pos_p = map(spikes_in_time, 2, car_po),
  #o_speed_p = map(spikes_in_time, 2, car_speed),
  #o_accel_p = map(spikes_in_time, 2, car_accel))
```
...
spatial_firing <- spatial_firing  %>%
    mutate(final_model_o_b  = pmap(list(o_pos_b, o_speed_b, o_accel_b), model_comparison),
           final_model_o_nb  = pmap(list(o_pos_nb, o_speed_nb, o_accel_nb), model_comparison))#%>%
...
spatial_firing <- spatial_firing  %>%
  mutate(o_pos_b_stdcoef = map2(spikes_in_time, 0, coef_pos),
         o_speed_b_stdcoef = map2(spikes_in_time, 0, coef_speed),
         o_accel_b_stdcoef = map2(spikes_in_time, 0, coef_accel),
         o_pos_nb_stdcoef = map2(spikes_in_time, 1, coef_pos),
         o_speed_nb_stdcoef = map2(spikes_in_time, 1, coef_speed),
         o_accel_nb_stdcoef = map2(spikes_in_time, 1, coef_accel))
