...
if (save_figures == 1) {
  ggsave(file = "plots/LMERProportions_beaconed.png", width = 4, height = 5.5)
}
```
...
## For supplemental 6, plot coefficents for remaining groups


_Plot coefficients for just speed cells_

6a. Plot coefficients for cells classified in Figure 2 as having a positive slope and in Figure 3 as having significant fit coefficients for speed only.
...
6b. Plot coefficients for cells classified in Figure 2 as having a negative slope and in Figure 3 as having significant fit coefficients for speed only.
...
6a. Plot coefficients for cells classified in Figure 2 as having a positive slope and in Figure 3 as having significant fit coefficients for acceleration only.
...
6b. Plot coefficients for cells classified in Figure 2 as having a negative slope and in Figure 3 as having significant fit coefficients for acceleration only.
...
6a. Plot coefficients for cells classified in Figure 2 as having a positive slope and in Figure 3 as having significant fit coefficients for position and acceleration. 
...
6b. Plot coefficients for cells classified in Figure 2 as having a negative slope and in Figure 3 as having significant fit coefficients for position and acceleration
