...
spatial_firing <- spatial_firing  %>%
  ...
  mutate(o_speed_b = map(spikes_in_time, 0, car_speed)) %>%
  mutate(o_accel_b = map(spikes_in_time, 0, car_accel)) #%>%
...
none <-subset(spatial_firing, lm_group == "None")
...
```{r}
spatial_firing_save <- subset(spatial_firing, select = c("session_id", "cluster_id", "unique_id", "o_pos_b_stdcoef", "o_speed_b_stdcoef","o_accel_b_stdcoef", "final_model_o_b", "lm_group"))
...
data_coef <- tibble(session_id = rep(unlist(spatial_firing_save$unique_id), times=3), 
                    ...
                    coef = c(as.character(spatial_firing_save$pos_stdcoef),
                             as.character(spatial_firing_save$speed_stdcoef),
                             as.character(spatial_firing_save$accel_stdcoef)), 
                    ...
                    lm_result = rep(as.character(spatial_firing_save$lm_result_o_rewarded_b), times=3)) 
```
...
ggplot(data=data_coef_pos, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_positivecells.png", width = 4, height = 4.5)
  
```


5. Split by negative slope
```{r}
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_negativecells.png", width = 4, height = 4.5)
...
ggplot(data=data_coef_pos, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_PA_positivecells.png", width = 4, height = 4.5)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_PA_negativecells.png", width = 4, height = 4.5)
