...
ggplot(data=data_coef_pos, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=9),
        ...
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Positioncells_positive.png", width = 2.7, height = 3)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=9),
        ...
        legend.text=element_text(size=9), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_negativecells.png", width = 2.7, height = 3)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_unclassifiedcells_pos.png", width = 3, height = 2.8)
