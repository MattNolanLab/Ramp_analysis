...
1. Split data based on conjunctive position encoding (PA, PS, PSA) (Figure 2) as we are only interested in these neurons here
...
1. Split data based on speed encoding group (Figure 2) as we are only interested in these neurons here
```{r}
