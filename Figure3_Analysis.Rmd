...
Fitting uses a generalised linear mixed effect model with a Tweedie resonse distribution.
Similar results are obtained using a linear mixed effect model (use the function compare_models_slope_glm instead).
```{r}
spatial_firing <- spatial_firing %>%
...
The numbers here are for all neurons that contain all three trial outcomes.
```{r}
spatial_firing <- spatial_firing %>%
