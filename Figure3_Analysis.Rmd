...
outcomes_offsets_data_negneg <- outcomes_offsets_data %>% filter(final_model_o_b == "P" | final_model_o_b == "PA"  | final_model_o_b == "PS"  | final_model_o_b == "PSA",
...
outcomes_offsets_data_speedneg <- outcomes_offsets_data %>% filter(final_model_o_b == "S" | final_model_o_b == "SA",
                lm_group_b == "Negative" & lm_group_b_h == "Negative")
```
