...
pos <-subset(spatial_firing, lm_group == "Positive")
neg <-subset(spatial_firing, lm_group == "Negative")
none <-subset(spatial_firing, lm_group == "Unclassified")
...
```{r}
spatial_firing_save <- subset(spatial_firing, select = c("session_id", "cluster_id", "unique_id", "o_pos_b_stdcoef", "o_speed_b_stdcoef","o_accel_b_stdcoef", "o_pos_nb_stdcoef", "o_speed_nb_stdcoef","o_accel_nb_stdcoef", "final_model_o_b", "lm_group", "lm_group_nb"))
...
data_coef <- tibble(session_id = rep(unlist(spatial_firing_save$unique_id), times=3), 
                    ...
                    coef_nb = c(as.character(spatial_firing_save$o_pos_nb_stdcoef),
                             as.character(spatial_firing_save$o_speed_nb_stdcoef),
                             as.character(spatial_firing_save$o_accel_nb_stdcoef)),
                    ...
                    lm_result = rep(as.character(spatial_firing_save$lm_group), times=3), 
                    lm_result_nb = rep(as.character(spatial_firing_save$lm_group_nb), times=3)) 
```
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_Unclassifiedcells.png", width = 3, height = 2.5)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_negativecells.png", width = 3, height = 2.5)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_unclassifiedcells_pos.png", width = 3, height = 2.5)
...
ggplot(data=data_coef_neg, aes(x = factor(coef_type), y = as.numeric(coef))) +
  ...
  theme(axis.text.x = element_text(size=12),
        ...
        legend.text=element_text(size=12), 
        axis.title.y = element_text(margin = margin(t = 0, r = 20, b = 0, l = 0))) +
ggsave(file = "plots/CoefficientValues_Position_unclassifiedcells_neg.png", width = 3, height = 2.5)
