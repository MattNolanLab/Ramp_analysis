...
```{r}
data <- subset(spatial_firing, track_catagory == "pospos" | track_catagory == "negneg" | track_catagory == "posneg" | track_catagory == "negpos" | track_catagory == "negnon" | track_catagory == "posnon")
```
