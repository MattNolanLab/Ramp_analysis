...
```{r}
spatial_firing <- spatial_firing %>%
  mutate(whole_track_catagory = map2(lm_group_b, lm_group_b_h, mark_track_catagory)) %>%
  mutate(whole_track_catagory_nb = map2(lm_group_nb, lm_group_nb_h, mark_track_catagory))
...
pospos <-nrow(subset(cueindependent_neurons, whole_track_catagory == "pospos"))/nrow(cueindependent_neurons)*100
posneg <-nrow(subset(cueindependent_neurons, whole_track_catagory == "posneg"))/nrow(cueindependent_neurons)*100
negneg <-nrow(subset(cueindependent_neurons, whole_track_catagory == "negneg"))/nrow(cueindependent_neurons)*100
negpos <-nrow(subset(cueindependent_neurons, whole_track_catagory == "negpos"))/nrow(cueindependent_neurons)*100

# positive homebound slopes
pospos_num <-nrow(subset(cueindependent_neurons, whole_track_catagory == "pospos"))
posneg_num <-nrow(subset(cueindependent_neurons, whole_track_catagory == "posneg"))
negneg_num <-nrow(subset(cueindependent_neurons, whole_track_catagory == "negneg"))
negpos_num <-nrow(subset(cueindependent_neurons, whole_track_catagory == "negpos"))
...
```{r}
data <- subset(spatial_firing, whole_track_catagory == "pospos" | whole_track_catagory == "negneg" | whole_track_catagory == "posneg" | whole_track_catagory == "negpos" | whole_track_catagory == "negnon" | whole_track_catagory == "posnon")
```
...
1. 
```{r}
data <- spatial_firing %>% filter(whole_track_catagory == "pospos" | whole_track_catagory == "negneg" | whole_track_catagory == "posneg"| whole_track_catagory == "negpos" | whole_track_catagory == "posnon"| whole_track_catagory == "negnon")
```
