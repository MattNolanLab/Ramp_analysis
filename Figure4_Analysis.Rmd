...
This analysis isn't so useful as there are relatively few probe trials results in insufficient power for classification. This may be useful for future experiments that optimise probe trial number.
...
This needs rewriting once access to the coefficients is clear.
