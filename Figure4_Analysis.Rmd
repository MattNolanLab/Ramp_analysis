...
if (save_figures == 1) {
 ggsave(file = "plots/slope_comparison_beaconed_vs_probe_outbound_pos.png", width = 4, height = 4) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/slope_comparison_beaconed_vs_probe_outbound_neg.png", width = 4, height = 4) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/slope_comparison_beaconed_vs_probe_homebound_pos.png", width = 4, height = 4) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/slope_comparison_beaconed_vs_probe_homebound_neg.png", width = 4, height = 4) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/offset_comparison_beaconed_vs_probe_pospos.png", width = 4, height = 4) 
}
...
if (save_figures == 1) {
 ggsave(file = "plots/offset_comparison_beaconed_vs_probe_negneg.png", width = 4, height = 4) 
}
...
# Look at non-beaconed trials too
spatial_firing_probe_only %>% filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>% comp_beacon_probe_rate_plots_3
