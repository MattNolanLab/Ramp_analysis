...
comp_beacon_probe_rate_plots <- function(df){
  a <- df %>% plot_beaconed_vs_probe("Negative", "Negative", "Negative", "Negative")
  
  b <- df %>% plot_beaconed_vs_probe("Negative", "Positive", "Negative", "Positive")
  
  c <- df %>% plot_beaconed_vs_probe("Positive", "Positive", "Positive", "Positive")
  
  d <- df %>% plot_beaconed_vs_probe("Positive", "Negative", "Positive", "Negative")
  
  return(list(a, b, b, d))
}

beacon_vs_probe_rbeates <- comp_beacon_probe_rate_plots(spatial_firing_probe_only)

b <- spatial_firing_probe_only %>% plot_beaconed_vs_probe("Negative", "Negative", "Unclassified", "Unclassified")

c <- spatial_firing_probe_only %>% plot_beaconed_vs_probe("Negative", "Negative", "Negative", "Negative")
