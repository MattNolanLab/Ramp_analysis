...
```{r}
(UCNeg_plot <- mean_SD_plots(position_neurons, "Unclassified", "Negative"))
...
```{r}
(UCPos_plot <- mean_SD_plots(position_neurons, "Unclassified", "Positive"))
# ggsave(file = "plots/AverageRates_PositionCells_NegPIonly.png", width = 3.5, height = 2.5)
```
...
Now, i want to visualise cue dependent and indepedent on the same plot so i can compare them
