...
```{r}
ggplot() + 
    geom_point(data=subset(reset, track_category == "pospos" | track_category == "negneg"),
    ...
    geom_point(data=subset(reset, track_category == "posneg" | track_category == "negpos"),
               aes(x = as.numeric(unlist(asr_b_h_rewarded_fit_slope)), 
                   y = as.numeric(unlist(asr_p_h_rewarded_fit_slope)), 
                   color=factor(unlist(lm_group_b))), shape=2, alpha=0.8) +
    geom_point(data=subset(reset, track_category == "posnon" | track_category == "negnon"),
               aes(x = as.numeric(unlist(asr_b_h_rewarded_fit_slope)), 
                   y = as.numeric(unlist(asr_p_h_rewarded_fit_slope)), 
...
```{r}
pospos_r <-subset(pi_data, track_category == "pospos" & reset_group == "Reset")
pospos_c <-subset(pi_data, track_category == "pospos" & reset_group == "Continuous")
posneg <-subset(pi_data,track_category == "posneg")
negpos <-subset(pi_data, track_category == "negpos")
negneg_r <-subset(pi_data, track_category == "negneg" & reset_group == "Reset")
negneg_c <-subset(pi_data, track_category == "negneg" & reset_group == "Continuous")
...
# Beaconed: pospos_r
# stays the same
pospos_r_pospos_r <-nrow(subset(pospos_r, track_category_p == "pospos" & reset_group_p == "Reset"))

# homebound changes
pospos_r_posneg <-nrow(subset(pospos_r, track_category_p == "posneg"))
pospos_r_posnon <-nrow(subset(pospos_r, track_category_p == "posnon"))
pospos_r_pospos <-nrow(subset(pospos_r, track_category_p == "pospos" & reset_group_p == "Continuous"))

# outbound changes
pospos_r_negpos <-nrow(subset(pospos_r, track_category_p == "negpos"))
pospos_r_negnon <-nrow(subset(pospos_r, track_category_p == "negnon"))
pospos_r_negneg <-nrow(subset(pospos_r, track_category_p == "negneg" & reset_group_p == "Continuous"))
pospos_r_negneg_r <-nrow(subset(pospos_r, track_category_p == "negneg" & reset_group_p == "Reset"))

# Beaconed: pospos_c
# stays the same
pospos_pospos <-nrow(subset(pospos_c, track_category_p == "pospos" & reset_group_p == "Continuous"))

# homebound changes
pospos_posneg <-nrow(subset(pospos_c, track_category_p == "posneg"))
pospos_posnon <-nrow(subset(pospos_c,track_category_p == "posnon"))
pospos_pospos_r <-nrow(subset(pospos_c, track_category_p == "pospos" & reset_group_p == "Reset"))

# outbound changes
pospos_negpos <-nrow(subset(pospos_c, track_category_p == "negpos"))
pospos_negnon <-nrow(subset(pospos_c, track_category_p == "negnon"))
pospos_negneg <-nrow(subset(pospos_c, track_category_p == "negneg" & reset_group_p == "Continuous"))
pospos_negneg_r <-nrow(subset(pospos_c, track_category_p == "negneg" & reset_group_p == "Reset"))

# Beaconed: posneg
posneg_posneg <-nrow(subset(posneg, track_category_p == "posneg"))

posneg_posnon <-nrow(subset(posneg, track_category_p == "posnon"))
posneg_pospos <-nrow(subset(posneg, track_category_p == "pospos" & reset_group_p == "Continuous"))
posneg_pospos_r <-nrow(subset(posneg, track_category_p == "pospos" & reset_group_p == "Reset"))

posneg_negpos <-nrow(subset(posneg, track_category_p == "negpos"))
posneg_negnon <-nrow(subset(posneg, track_category_p == "negnon"))
posneg_negneg <-nrow(subset(posneg, track_category_p == "negneg" & reset_group_p == "Continuous"))
posneg_negneg_r <-nrow(subset(posneg, track_category_p == "negneg" & reset_group_p == "Reset"))


# Beaconed: negneg_r
# stays the same
negneg_r_negneg_r <-nrow(subset(negneg_r, track_category_p == "negneg" & reset_group_p == "Reset"))

# homebound changes
negneg_r_negpos <-nrow(subset(negneg_r, track_category_p == "negpos"))
negneg_r_negnon <-nrow(subset(negneg_r, track_category_p == "negnon"))
negneg_r_negneg <-nrow(subset(negneg_r, track_category_p == "negneg" & reset_group_p == "Continuous"))

# outbound changes
negneg_r_posneg <-nrow(subset(negneg_r, track_category_p == "posneg"))
negneg_r_posnon <-nrow(subset(negneg_r,track_category_p == "posnon"))
negneg_r_pospos <-nrow(subset(negneg_r, track_category_p == "pospos" & reset_group_p == "Continuous"))
negneg_r_pospos_r <-nrow(subset(negneg_r, track_category_p == "pospos" & reset_group_p == "Reset"))


# Beaconed: negneg_c
# stays the same
negneg_negneg <-nrow(subset(negneg_c, track_category_p == "negneg" & reset_group_p == "Continuous"))

# homebound changes
negneg_negpos <-nrow(subset(negneg_c, track_category_p == "negpos"))
negneg_negnon <-nrow(subset(negneg_c, track_category_p == "negnon"))
negneg_negneg_r <-nrow(subset(negneg_c, track_category_p == "negneg" & reset_group_p == "Reset"))

# outbound changes
negneg_posneg <-nrow(subset(negneg_c, track_category_p == "posneg"))
negneg_posnon <-nrow(subset(negneg_c, track_category_p == "posnon"))
negneg_pospos <-nrow(subset(negneg_c, track_category_p == "pospos" & reset_group_p == "Continuous"))
negneg_pospos_r <-nrow(subset(negneg_c, track_category_p == "pospos" & reset_group_p == "Reset"))
...
negpos_negneg <-nrow(subset(negpos, track_category_p == "negneg" & reset_group_p == "Continuous"))
negpos_negneg_r <-nrow(subset(negpos, track_category_p == "negneg" & reset_group_p == "Reset"))

# Outbound changes
negpos_posneg <-nrow(subset(negpos, track_category_p == "posneg"))
negpos_posnon <-nrow(subset(negpos, track_category_p == "posnon"))
negpos_pospos <-nrow(subset(negpos, track_category_p == "pospos" & reset_group_p == "Continuous"))
negpos_pospos_r <-nrow(subset(negpos, track_category_p == "pospos" & reset_group_p == "Reset"))
...
posnon_pospos <-nrow(subset(posnon, track_category_p == "pospos" & reset_group_p == "Continuous"))
posnon_pospos_r <-nrow(subset(posnon, track_category_p == "pospos" & reset_group_p == "Reset"))

posnon_negpos <-nrow(subset(posnon, track_category_p == "negpos"))
posnon_negnon <-nrow(subset(posnon, track_category_p == "negnon"))
posnon_negneg <-nrow(subset(posnon, track_category_p == "negneg" & reset_group_p == "Continuous"))
posnon_negneg_r <-nrow(subset(posnon, track_category_p == "negneg" & reset_group_p == "Reset"))
...
negnon_negneg <-nrow(subset(negnon, track_category_p == "negneg" & reset_group_p == "Continuous"))
negnon_negneg_r <-nrow(subset(negnon, track_category_p == "negneg" & reset_group_p == "Reset"))

# Outbound changes
negnon_posneg <-nrow(subset(negnon, track_category_p == "posneg"))
negnon_posnon <-nrow(subset(negnon, track_category_p == "posnon"))
negnon_pospos <-nrow(subset(negnon, track_category_p == "pospos" & reset_group_p == "Continuous"))
negnon_pospos_r <-nrow(subset(negnon, track_category_p == "pospos" & reset_group_p == "Reset"))
...
## is the grouping, i.e. neurons that are ++(o) in beaconed but not probe - dictated by anything?
...
4. find ones that stay the same on beaconed and probe trials
```{r}
pospos_r_same <-subset(pospos_r, track_category_p == "pospos" & reset_group_p == "Reset")
negneg_r_same <-subset(negneg_r, track_category_p == "negneg" & reset_group_p == "Reset")
...
5. Find ones that switch i.e. either become continuous or something else on the homebound zone
```{r}
pospos_r_switch <-subset(pospos_r, track_category_p == "pospos" & reset_group_p == "Continuous")
negneg_r_switch <-subset(negneg_r, track_category_p == "negneg" & reset_group_p == "Continuous")

pospos_r_un <-subset(pospos_r, track_category_p != "pospos")
negneg_r_un <-subset(negneg_r, track_category_p != "negneg")

```


6. Plot scatter of training day versus trial number for these groups above
```{r}
ggplot() + 
    geom_point(data=pospos_r_same,aes(x = as.numeric(Day_numeric), 
                                      y = as.numeric(hit_trials_number)), colour = "chartreuse3") +
    geom_point(data=pospos_r_switch,aes(x = as.numeric(Day_numeric), 
                                        y = as.numeric(hit_trials_number)), shape=1, colour = "chartreuse3") +
    geom_point(data=pospos_r_un,aes(x = as.numeric(Day_numeric), 
                                    y = as.numeric(hit_trials_number)), shape=1, colour = "chartreuse3") +
    geom_point(data=negneg_r_same,aes(x = as.numeric(Day_numeric), 
                                      y = as.numeric(hit_trials_number)), colour = "violetred2") +
    geom_point(data=negneg_r_switch,aes(x = as.numeric(Day_numeric), 
                                        y = as.numeric(hit_trials_number)), shape=1, colour = "violetred2") +    
    geom_point(data=negneg_r_un,aes(x = as.numeric(Day_numeric), 
                                    y = as.numeric(hit_trials_number)), shape=1, colour = "violetred2") +    
    coord_cartesian(xlim = c(5,40), ylim = c(30,150)) +
    theme_classic() +
    theme(axis.text.x = element_text(size=17),
          axis.text.y = element_text(size=17),
          legend.position="bottom", 
...
if (save_figures == 1) {
 ggsave(file = "plots/test_fig6.png", width = 4, height = 4) 
}
```


7. Plot scatter of slope from linear model versus r.squared value s for these groups above

```{r}
ggplot() + 
    geom_point(data=pospos_r_same,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                      y = as.numeric(asr_b_o_rewarded_fit_r.squared)), colour = "chartreuse3") +
    geom_point(data=pospos_r_switch,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                        y = as.numeric(asr_b_o_rewarded_fit_r.squared)), shape=1, colour = "chartreuse3") +
    geom_point(data=pospos_r_un,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                    y = as.numeric(asr_b_o_rewarded_fit_r.squared)), shape=1, colour = "chartreuse3") +
    geom_point(data=negneg_r_same,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                      y = as.numeric(asr_b_o_rewarded_fit_r.squared)), colour = "violetred2") +
    geom_point(data=negneg_r_switch,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                        y = as.numeric(asr_b_o_rewarded_fit_r.squared)), shape=1, colour = "violetred2") +    
    geom_point(data=negneg_r_un,aes(x = as.numeric(asr_b_o_rewarded_fit_slope), 
                                    y = as.numeric(asr_b_o_rewarded_fit_r.squared)), shape=1, colour = "violetred2") +    
...
7. Plot scatter of offset in beaconed trials versus offset in probe trials for these groups above
```{r}
ggplot() + 
    geom_point(data=pospos_r_same,aes(x = as.numeric(predict_diff), 
                                      y = as.numeric(predict_diff_p)), colour = "chartreuse3") +
    geom_point(data=pospos_r_switch,aes(x = as.numeric(predict_diff), 
                                        y = as.numeric(predict_diff_p)), shape=1, colour = "chartreuse3") +
    geom_point(data=pospos_r_un,aes(x = as.numeric(predict_diff), 
                                    y = as.numeric(predict_diff_p)), shape=1, colour = "chartreuse3") +
    geom_point(data=negneg_r_same,aes(x = as.numeric(predict_diff), 
                                      y = as.numeric(predict_diff_p)), colour = "violetred2") +
    geom_point(data=negneg_r_switch,aes(x = as.numeric(predict_diff), 
                                        y = as.numeric(predict_diff_p)), shape=1, colour = "violetred2") +    
    geom_point(data=negneg_r_un,aes(x = as.numeric(predict_diff), 
                                    y = as.numeric(predict_diff_p)), shape=1, colour = "violetred2") +    
    #geom_abline(intercept = 0, slope = 1, colour = "grey", linetype = "dashed") +
    theme_classic() +
    scale_color_manual(values=c("violetred2", "chartreuse3", "grey")) +
