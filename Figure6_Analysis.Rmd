...
# Beaconed: pospos_r
# stays the same
pospos_r_pospos_r <-nrow(subset(pospos_r, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
...
pospos_r_pospos <-nrow(subset(pospos_r, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
...
pospos_r_negneg <-nrow(subset(pospos_r, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
pospos_r_negneg_r <-nrow(subset(pospos_r, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

# Beaconed: pospos_c
# stays the same
pospos_pospos <-nrow(subset(pospos_c, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
...
pospos_pospos_r <-nrow(subset(pospos_c, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
...
pospos_negneg <-nrow(subset(pospos_c, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
pospos_negneg_r <-nrow(subset(pospos_c, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))
...
posneg_pospos <-nrow(subset(posneg, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
posneg_pospos_r <-nrow(subset(posneg, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
...
posneg_negneg <-nrow(subset(posneg, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
posneg_negneg_r <-nrow(subset(posneg, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))


# Beaconed: negneg_r
# stays the same
negneg_r_negneg_r <-nrow(subset(negneg_r, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))
...
negneg_r_negneg <-nrow(subset(negneg_r, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
...
negneg_r_pospos <-nrow(subset(negneg_r, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negneg_r_pospos_r <-nrow(subset(negneg_r, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))


# Beaconed: negneg_c
# stays the same
negneg_negneg <-nrow(subset(negneg_c, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
...
negneg_negneg_r <-nrow(subset(negneg_c, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))
...
negneg_pospos <-nrow(subset(negneg_c, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negneg_pospos_r <-nrow(subset(negneg_c, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
...
negpos_negneg <-nrow(subset(negpos, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
negpos_negneg_r <-nrow(subset(negpos, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))
...
negpos_pospos <-nrow(subset(negpos, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negpos_pospos_r <-nrow(subset(negpos, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
