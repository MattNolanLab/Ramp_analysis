...
```{r}
spatial_firing <- spatial_firing %>%
  mutate(track_reset_group_p = pmap(list(lm_group_p, lm_group_p_h, reset_group_p), mark_track_category))
...
```{r}
data <- spatial_firing %>% filter(track_catagory_p == "pospos" | track_catagory_p == "negneg" | track_catagory_p == "posneg"| track_catagory_p == "negpos"| track_catagory_p == "posnon"| track_catagory_p == "negnon")
```
...
pospos_posneg <-nrow(subset(pospos_c, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
pospos_negpos <-nrow(subset(pospos_c, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
pospos_negnon <-nrow(subset(pospos_c, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
pospos_posnon <-nrow(subset(pospos_c, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
pospos_pospos <-nrow(subset(pospos_c, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
pospos_negneg <-nrow(subset(pospos_c, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
pospos_pospos_r <-nrow(subset(pospos_c, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
pospos_negneg_r <-nrow(subset(pospos_c, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

negpos_posneg <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negpos_negpos <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negpos_negnon <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negpos_posnon <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negpos_pospos <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negpos_negneg <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
negpos_pospos_r <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
negpos_negneg_r <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

posneg_posneg <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
posneg_negpos <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
posneg_negnon <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
posneg_posnon <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
posneg_pospos <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
posneg_negneg <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
posneg_pospos_r <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
posneg_negneg_r <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

negneg_posneg <-nrow(subset(negneg_c, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negneg_negpos <-nrow(subset(negneg_c, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negneg_negnon <-nrow(subset(negneg_c, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negneg_posnon <-nrow(subset(negneg_c, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negneg_pospos <-nrow(subset(negneg_c, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negneg_negneg <-nrow(subset(negneg_c, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
negneg_pospos_r <-nrow(subset(negneg_c, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
negneg_negneg_r <-nrow(subset(negneg_c, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

pospos_r_posneg <-nrow(subset(pospos_r, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
pospos_r_negpos <-nrow(subset(pospos_r, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
pospos_r_negnon <-nrow(subset(pospos_r, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
pospos_r_posnon <-nrow(subset(pospos_r, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
pospos_r_pospos <-nrow(subset(pospos_r, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
pospos_r_negneg <-nrow(subset(pospos_r, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
pospos_r_pospos_r <-nrow(subset(pospos_r, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
pospos_r_negneg_r <-nrow(subset(pospos_r, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))

negneg_r_posneg <-nrow(subset(negneg_r, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negneg_r_negpos <-nrow(subset(negneg_r, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negneg_r_negnon <-nrow(subset(negneg_r, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negneg_r_posnon <-nrow(subset(negneg_r, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negneg_r_pospos <-nrow(subset(negneg_r, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Continuous"))
negneg_r_negneg <-nrow(subset(negneg_r, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Continuous"))
negneg_r_pospos_r <-nrow(subset(negneg_r, lm_group_nb == "Positive" & lm_group_p_h == "Positive" & reset_group_nb == "Reset"))
negneg_r_negneg_r <-nrow(subset(negneg_r, lm_group_nb == "Negative" & lm_group_p_h == "Negative" & reset_group_nb == "Reset"))
...
```{r}
pospos_posneg <-nrow(subset(pospos, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
pospos_negpos <-nrow(subset(pospos, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
pospos_negnon <-nrow(subset(pospos, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
pospos_posnon <-nrow(subset(pospos, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
pospos_pospos <-nrow(subset(pospos, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
pospos_negneg <-nrow(subset(pospos, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))

negpos_posneg <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negpos_negpos <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negpos_negnon <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negpos_posnon <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negpos_pospos <-nrow(subset(negpos, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
negpos_negneg <-nrow(subset(negpos, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))

posneg_posneg <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
posneg_negpos <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
posneg_negnon <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
posneg_posnon <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
posneg_pospos <-nrow(subset(posneg, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
posneg_negneg <-nrow(subset(posneg, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))

negneg_posneg <-nrow(subset(negneg, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negneg_negpos <-nrow(subset(negneg, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negneg_negnon <-nrow(subset(negneg, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negneg_posnon <-nrow(subset(negneg, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negneg_pospos <-nrow(subset(negneg, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
negneg_negneg <-nrow(subset(negneg, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))

negnon_posneg <-nrow(subset(negnon, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
negnon_negpos <-nrow(subset(negnon, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
negnon_negnon <-nrow(subset(negnon, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
negnon_posnon <-nrow(subset(negnon, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
negnon_pospos <-nrow(subset(negnon, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
negnon_negneg <-nrow(subset(negnon, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))

posnon_posneg <-nrow(subset(posnon, lm_group_nb == "Positive" & lm_group_p_h == "Negative"))
posnon_negpos <-nrow(subset(posnon, lm_group_nb == "Negative" & lm_group_p_h == "Positive"))
posnon_negnon <-nrow(subset(posnon, lm_group_nb == "Negative" & lm_group_p_h == "Unclassified"))
posnon_posnon <-nrow(subset(posnon, lm_group_nb == "Positive" & lm_group_p_h == "Unclassified"))
posnon_pospos <-nrow(subset(posnon, lm_group_nb == "Positive" & lm_group_p_h == "Positive"))
posnon_negneg <-nrow(subset(posnon, lm_group_nb == "Negative" & lm_group_p_h == "Negative"))
