...
pospos <-subset(position_cells, lm_group_b == "Positive" & lm_group_b_h == "Positive")
negneg <-subset(position_cells, lm_group_b == "Negative" & lm_group_b_h == "Negative")

posneg <-subset(position_cells, lm_group_b == "Positive" & lm_group_b_h == "Negative")
negpos <-subset(position_cells, lm_group_b == "Negative" & lm_group_b_h == "Positive")

posnon <-subset(position_cells, lm_group_b == "Positive" & lm_group_b_h == "Unclassified")
negnon <-subset(position_cells, lm_group_b == "Negative" & lm_group_b_h == "Unclassified")

```

4. Have a look at slopes in this group
```{r}
posneg <- posneg %>%
  select(lm_group_nb, lm_group_nb_h, lm_group_p, lm_group_p_h)
```
...
```{r}
posneg_un_probe <-subset(posneg, lm_group_p == "Positive" & lm_group_p_h == "Unclassified")
negpos_un_probe <-subset(negpos, lm_group_p == "Negative" & lm_group_p_h == "Unclassified")
...
```{r}
pospos_r_same <-subset(pospos_r, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_p == "Reset")
pospos_c_same <-subset(pospos_c, lm_group_p == "Positive" & lm_group_p_h == "Positive" & reset_group_p == "Continuous")
negneg_r_same <-subset(negneg_r, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_p == "Reset")
negneg_c_same <-subset(negneg_c, lm_group_p == "Negative" & lm_group_p_h == "Negative" & reset_group_p == "Continuous")
...
```{r}
pi_data <- subset(spatial_firing, lm_group_b == "Positive" | lm_group_b == "Negative")
```
