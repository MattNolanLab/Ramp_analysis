...
extract_cols_for_plot <- function(df){
 df <- tibble(Position = rep(1:200, times=nrow(df)), 
             ...
             Outbound_beaconed = rep(df$lm_group_p, each=200), 
             Homebound_beaconed = rep(df$lm_group_p_h, each=200), 
...
spatial_firing %>%
  ...
  filter(Outbound_beaconed == "Negative" & Homebound_beaconed == "Negative") %>%
...
spatial_firing %>%
  ...
  filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>%
  extract_cols_for_plot() %>%
  filter(Outbound_beaconed == "Negative" & Homebound_beaconed == "Positive") %>%
  group_by(Position) %>%
  dplyr::summarise(mean_b = mean(Rates, na.rm = TRUE), sd_b = std.error(Rates, na.rm = TRUE)) %>%
  mutate(Position = rep(-30:169)) %>%
  mean_SEM_plots()
...
spatial_firing %>%
  ...
  filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>%
  extract_cols_for_plot() %>%
  filter(Outbound_beaconed == "Positive" & Homebound_beaconed == "Positive") %>%
  filter(reset_group == "Continuous") %>%
  group_by(Position) %>%
  dplyr::summarise(mean_b = mean(Rates, na.rm = TRUE), sd_b = std.error(Rates, na.rm = TRUE)) %>%
  mutate(Position = rep(-30:169)) %>%
...
spatial_firing %>%
  ...
  filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>%
  extract_cols_for_plot() %>%
  filter(Outbound_beaconed == "Positive" & Homebound_beaconed == "Negative") %>%
  group_by(Position) %>%
  dplyr::summarise(mean_b = mean(Rates, na.rm = TRUE), sd_b = std.error(Rates, na.rm = TRUE)) %>%
  mutate(Position = rep(-30:169)) %>%
  mean_SEM_plots()
...
spatial_firing %>%
  ...
  filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>%
  extract_cols_for_plot() %>%
  filter(Outbound_beaconed == "Positive" & Homebound_beaconed == "Unclassified") %>%
  group_by(Position) %>%
  dplyr::summarise(mean_b = mean(Rates, na.rm = TRUE), sd_b = std.error(Rates, na.rm = TRUE)) %>%
  mutate(Position = rep(-30:169)) %>%
  mean_SEM_plots()
...
spatial_firing %>%
  ...
  filter(final_model_o_b == "P" | final_model_o_b == "PS" | final_model_o_b == "PA" | final_model_o_b == "PSA") %>%
  extract_cols_for_plot() %>%
  filter(Outbound_beaconed == "Negative" & Homebound_beaconed == "Unclassified") %>%
  group_by(Position) %>%
  dplyr::summarise(mean_b = mean(Rates, na.rm = TRUE), sd_b = std.error(Rates, na.rm = TRUE)) %>%
  mutate(Position = rep(-30:169)) %>%
  mean_SEM_plots()
...
if (save_figures == 1) {
  ggsave(file = "plots/model_movement_njb.png", width = 24, height = 18)
}
```
